  ...
  return (
    <>
      <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
        ...
        <Link href ="/free" target="_blank" className="underline text-orange-400 font-bold mt-2">
          Try free Demo here
        </Link>
      ...
      {/* Features Section  */}
      <div className="mt-20 mb-20 max-w-5xl mx-auto sm:mt-40" >
      <h1 className="mx-auto text-center font-bold text-5xl max-w-4xl mb-20">Look at our <span className="text-orange-400">Features</span></h1>
      <Carousel>
        <CarouselContent>
            ...
            <div>
               <Card>
                  <CardContent className="flex aspect-square items-center justify-center p-6">
                    <span className="text-3xl font-semibold">Feature 1</span>
                  </CardContent>
                </Card>
            </div>
          </CarouselItem>
          <CarouselItem className="md:basis-1/2 lg:basis-1/3">
            <div>
               <Card>
                  <CardContent className="flex aspect-square items-center justify-center p-6">
                    <span className="text-3xl font-semibold">Feature 2</span>
                  </CardContent>
                </Card>
            </div>
          </CarouselItem>
          <CarouselItem className="md:basis-1/2 lg:basis-1/3">
            <div>
               <Card>
                  <CardContent className="flex aspect-square items-center justify-center p-6">
                    <span className="text-3xl font-semibold">Feature 3</span>
                  </CardContent>
                </Card>
            </div>
          </CarouselItem>
          <CarouselItem className="md:basis-1/2 lg:basis-1/3">
            <div>
               <Card>
                  <CardContent className="flex aspect-square items-center justify-center p-6">
                    <span className="text-3xl font-semibold">Feature 4</span>
                  </CardContent>
                </Card>
            </div>
          </CarouselItem>
